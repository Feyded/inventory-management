      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="relative">
            ...
            <span className="absolute -top-2 -right-2 inline-flex items-center justify-center px-[0.4rem] py-1 text-xs font-semibold leadning-none text-red-100 bg-red-400 rounded-full">
              3
            </span>
          </div>
