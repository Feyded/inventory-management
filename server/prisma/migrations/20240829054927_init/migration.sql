...
-- CreateTable
CREATE TABLE "ExpenseSummaryCategory" (
    "expenseSummaryCategoryId" TEXT NOT NULL,
    "expenseSummaryId" TEXT NOT NULL,
    "category" TEXT NOT NULL,
    "amount" BIGINT NOT NULL,
    "date" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ExpenseSummaryCategory_pkey" PRIMARY KEY ("expenseSummaryCategoryId")
);
...
-- AddForeignKey
ALTER TABLE "ExpenseSummaryCategory" ADD CONSTRAINT "ExpenseSummaryCategory_expenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryId") REFERENCES "ExpenseSummary"("expenseSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
